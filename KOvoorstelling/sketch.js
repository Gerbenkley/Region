...
function draw() {
      ...
      scaledx  = map(mouseX, 0, windowWidth, 80, 117);
      scaledx2 = map(mouseX, 0, windowWidth, 117, 80);
      scaledy  = map(mouseY, 0, windowHeight, 255, 200);
        ...
        if (clickedvar > 0) {
          ...
          background(0, scaledx, scaledx2, 100);
          fill(27, 204, 133);
          strokeWeight(0);
          ...
          textAlign(CENTER);
          text(text4, 0, windowHeight-100, windowWidth, windowHeight);
          drawTree();
          drawFlowers();
...
function drawTree() {
  ...
  scaledx2 = map(mouseX, 0, windowWidth, 80, 150);
  scaledx3 = map(mouseX, 0, windowWidth, -50, 50)
  scaledy2 = map(mouseY, 0, windowHeight, 20, 60);
  scaledy3 = map(mouseY, 0, windowHeight, 200, 225);

  strokeWeight(2.5);
  stroke(scaledx2, scaledy2, 0, 80);
  // Let's pick an angle 0 to 90 degrees based on the mouse position
  let a = 15 + (mouseY / windowHeight) * 35;
  // Convert it to radians
  theta = radians(a);
  // Start the tree from the bottom of the screen
  translate(windowWidth/2 + scaledx3, windowHeight-scaledy3);
